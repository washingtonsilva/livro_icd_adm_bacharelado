...
O objetivo principal deste capítulo é proporcionar uma compreensão sólida da linguagem 
R, desde suas origens, fundamentos até aplicações básicas em análise de dados, 
...
R é um ambiente ou sistema para computação estatística e gráfico. Esse 
...
A linguagem R é considerada uma linguagem de domínio específico (*Domain Specific 
Language*, DSL). No caso de R, o domínio e a computação estatística. Por extensão, 
...
- **Março de 2026**: Estamos atualmente na versão R 4.5.2
:::
...
a tipos específicos de operações e análises. As principais estruturas de dados são:
...
estatísticos e que podem ser diretamente aplicáveis a vetores. 
...
# tamanho ou numero de elemtnos do vetor
length(retornos) 
```
...
estatísticas. Conceotualmente similar a uma planilha, um data frame organiza 
...
do ecosistema tidyverse. Mantêm compatibilidade com data frames tradicionais, 
