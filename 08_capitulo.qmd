...
e a linguagem R. Você aprenderá como criar e editar textos e código R e 
a visualizar o documento renderizado na guia `Viewer` do RStudio enquanto 
trabalha em um documento computacional.
...
![Sistema Quarto: um formato, diversos produtos.](img/08-cap/fig01.png){#fig-1 fig-align="center" width="100%"}
...
![Funcionamento do Sistema Quarto com a linguagem R.](img/08-cap/fig02.png){#fig-2 fig-align="center" width="100%"}
...
- Como destacamos no @sec-rstudio é importante utilizar um Projeto 
RStudio para organizar seus projetos de análise de dados nos quais 
você utiliza a linguagem R. 

Assim, neste capítulo, assumimos que você já criou um projeto RStudio 
...
![Criando um arquivo quarto no RStudio usando o ícone para criação rápida de arquivos.](img/08-cap/fig04.jpeg){#fig-4 fig-align="center"}


3. Utilizando qualquer uma das opções anteriores, após clicar em 
`Quarto Document`, aparecerá a interface exibida na @fig-5:

![Interface do RStudio para criar um arquivo Quarto.](img/08-cap/fig05.jpeg){#fig-5 fig-align="center"}
...
![Arquivo Quarto padrão criado pelo RStudio.](img/08-cap/fig06.jpeg){#fig-6 fig-align="center"}
...
![](img/08-cap/render-button.png){width=25px height=25px style="vertical-align:middle;"} Render, localizado na barra superior do painel `Source` do Rstudio, 
como mostra a @fig-7.

![Renderizando um arquivo quarto.](img/08-cap/rstudio-render.png){#fig-7 fig-align="center"}
...
![Renderizando um arquivo quarto.](img/08-cap/fig08.jpeg){#fig-8 fig-align="center"}
...
## Criando Relatórios Quarto em Diversos Formatos 
...
A @tbl-2 exibe apenas os parâmetros específicos do formato Typst 
...
Dominar alguns atalhos de teclado básicos aumentará significativamente sua 
produtividade no RStudio, especialmente ao trabalhar com documentos Quarto.
