...
Integrado RStudio, incluindo orientações sobre como instarlar, 
...
O RStudio é um **Ambiente de Desenvolvimento Integrado** voltado para a
linguagem R. Em vez de abrir programas separados para escrever, executar e
visualizar resultados, um ambiente de desenvolvimento integrado 
reúne tudo em uma única interface.

::: {.callout-note icon="false"}
## O que é um IDE?

Um Ambiente de Desenvolvimento Integrado (em inglês,*Integrated Development Environment*, IDE)  integra editor de texto, execução de código, ajuda, 
visualização de gráficos e organização de projetos. Isso reduz erros e 
acelera o aprendizado.
:::

Para quem está começando, a vantagem é simples: você escreve um script,
...
Para instalar o RStudio em um computador com Windows, execute 
os seguintes passos:
...
Com o RStudio instalado, vamos entender o que ele é e por que este ambiente 
de desenvolvimento integrado para a linguagem R facilita o trabalho de 
analistas e cientistas de dados, além de ser muito amigável para 
iniciantes.
...
As principais vantagens do RStudio são:
...
- **Aumento da produtividade**: Recursos como autocompletar código, 
...
- Abrir o RStudio sem ter o R instalado: instale a linguagem R antes do RStudio.
...
Ao abrir o RStudio, você verá quatro **painéis**. Eles funcionam em conjunto
...
- O painel `Source` permite a visualização e edição de 
diversos tipos vários arquivos, tais como: `.R`, `.qmd`,
...
mesmo projeto funcione corretamente em diferentes computadores e sistemas
...
7. Como destacamos no @sec-estudo-caso-introdutorio, é importante
adotar a prática de organizar projetos de análise de dados por 
meio de uma estrutura clara de diretórios. Embora essas pastas
possam ser criadas manualmente pelo sistema operacional, utilizar 
recursos da própria linguagem R traz duasvantagens importantes: 
(i) documenta explicitamente a estrutura do
...
Para criar a estrutura de pastas solicitada, basta 
digitar cada um dos seguintes comandos em sequência no 
console R do RStudio:
